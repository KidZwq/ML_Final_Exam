...
def build_dict(imgs, wtoi, params):
    ...
    refs_idxs = []
    for img in imgs:
        if 'sentences' not in img or not img['sentences']:
            continue  # Skip images without any sentences
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/root/autodl-tmp/TSG/data/cocobu.json', help='input json file to process into hdf5')
